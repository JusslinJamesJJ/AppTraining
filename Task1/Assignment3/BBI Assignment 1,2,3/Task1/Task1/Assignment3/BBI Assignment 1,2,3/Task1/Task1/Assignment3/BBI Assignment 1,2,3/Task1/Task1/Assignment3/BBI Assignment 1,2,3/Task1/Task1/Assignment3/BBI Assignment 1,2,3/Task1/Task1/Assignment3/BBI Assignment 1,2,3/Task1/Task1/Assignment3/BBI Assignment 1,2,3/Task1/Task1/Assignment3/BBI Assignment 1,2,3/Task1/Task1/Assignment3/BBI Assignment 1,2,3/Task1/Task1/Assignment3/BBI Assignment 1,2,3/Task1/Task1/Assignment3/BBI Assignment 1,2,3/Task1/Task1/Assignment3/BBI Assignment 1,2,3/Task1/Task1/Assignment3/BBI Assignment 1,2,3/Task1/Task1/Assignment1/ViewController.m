...
- (void)viewDidLayoutSubviews{
         ...
         //custom textfield
         //name Tf
 //            _nameTf.autoresizingMask=UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleRightMargin |UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleTopMargin;
...
//            UIImageView *imgforRight=[[UIImageView alloc] initWithFrame:CGRectMake(500, 0, 20, 20)];
...
//               _passwordError.text=@"Use Minimum 8 characters, at least 1 uppercase letter, 1 lowercase letter, 1 number and 1 special character";
           }
...
//    NSString *passRegex = @"^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$";

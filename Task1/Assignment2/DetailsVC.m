...
- (void)viewDidLoad {
    ...
    idLabel.text=string_id;
    numtreeLabel.text=string_numtreeLabel;
    nametreeLabel.text=string_nametreeLabel;
    tocnametreeLabel.text=string_tocnametreeLabel;
    htmlpageLabel.text=string_htmlpageLabel;
    haspdfLabel.text=string_haspdfLabel;
    emailcontentLAbel.text=string_emailcontentLAbel;
